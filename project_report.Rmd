...
User can interact with the map, box plot and bar chart by selecting the price range they want, the continent of origin they preferred and the single rating they like. The map and the plots would then change accordingly. The interactive map could effectively help user find the countries of wine origin at the reasonable price and rating they want.
