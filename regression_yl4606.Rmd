...
# test significance of interactions between points and variety: log_price ~ points*variety
...
# (for easier interpretation) Stratified analysis: fit separate regression models by continent
```{r}
