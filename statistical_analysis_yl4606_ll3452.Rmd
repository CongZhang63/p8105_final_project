...
Yes. By doing an ANOVA test, we find that p-value equals to zero, which tells us that the larger model **Log_Price ~ Points + Variety + Continent** is superior over **Log_Price ~ Points + Variety**, which means continent is indeed a significant variable. Therefore, we add continent into our model and get the following estimates:
