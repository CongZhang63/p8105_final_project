...
### Import `winemag-data-130k-v2.csv` data.

```{r wine130_df, message = FALSE}
wine130_df = 
...
### Create average points and price at the country and province levels respectively for  `winemag-data-130k-v2.csv` data.
...
Due to 63 missing values of country and province in `winemag-data-130k-v2.csv` data, average points and price are also created for this missing group. Caution is needed for subsequent analysis.

<br/>

### Create average points and price at the variety and winery levels respectively for  `winemag-data-130k-v2.csv` data.
...
save(wine130_tidy, file = "./data/wine130_tidy")
```

Due to 1 missing value of variety in `winemag-data-130k-v2.csv` data, average points and price are also created for this missing group. Caution is needed for subsequent analysis.
